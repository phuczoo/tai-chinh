...
import { AnalyticsTransitionProvider, AnalyticsTransitionOverlay } from '@/components/AnalyticsTransitionContext';
  ...
  return (
    <AnalyticsTransitionOverlay>
      <div className="space-y-6">
        ...
        {/* Dự báo tài chính & Trình giả lập tích lũy (Giai đoạn 5) */}
        <div className="w-full">
          <FinancialForecast analyticsData={analyticsData} netWorthData={netWorthData} />
        </div>
